...
jQuery(document).ready(function(){
	...
	function interpret (obj) {
		...
		switch(classList[classNum-3]){
			case "print":
				// alert(obj.html());
				return printCodeGenerate(obj);
				break;
			case "assign":
				return assignCodeGenerate(obj);
				break;
			case "for":
			...
			case "subroutine":
				...
				break;
			default:
				alert("default:"+classList[classNum-3]);
				break;
		}
	}
//データブロックレベルの解析メソッド群
...
//処理ブロックごとの解析メソッド群
	...
	function forCodeGenerate (obj) {
		...
		var forCode="";
		forCode+="for(var hoge=0;hoge<"+loopTimes+";hoge++){";
